...
<!--
**MiguelVentoso28/MiguelVentoso28** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
| Category | Tools |
|---|---|
| **Middleware** | ROS2 Humble, Nav2, MoveIt 2, BehaviorTree.CPP |
| **Simulation** | MuJoCo, NVIDIA Isaac Sim, Isaac Lab, Gazebo |
| **ML & AI** | PyTorch, Reinforcement Learning (sim-to-real), OpenCV |
| **CAD & Manufacturing** | SolidWorks, CATIA v5, AutoCAD, FDM 3D Printing |
| **FEA & CFD** | ANSYS, Abaqus, XFlow |
| **Dev Tools** | Git, Docker, Linux/Ubuntu, C++, Python |
| **Hardware** | Doosan M0609, Franka Emika, AGV/AMR, Arduino |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-MiguelVentoso-0077B5?style=flat&logo=linkedin)](https://linkedin.com/in/MiguelVentoso)
[![Email](https://img.shields.io/badge/Email-Miguelventoso28@gmail.com-D14836?style=flat&logo=gmail)](mailto:Miguelventoso28@gmail.com)
